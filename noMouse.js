...
function init_grid(){
    ...
    selector.style = "position: absolute; top: -50px; left: -50px; width: 20px; height: 20px; background-color: #ff0000; box-shadow: 10px 10px 5px #990000;";
...
function reset_grid(){
    ...
    div.style = "background-color: none; border: 3px solid #ff00ff; position: fixed; top: 0; left: 0; z-index: 100; border-radius: 10px; pointer-events: none;";
    div.style.top = 0 + "px";
    div.style.left = 0 + "px";
    div.style.width = (window.innerWidth - 4) + "px";
    div.style.height = (window.innerHeight - 6) + "px";
    grid_pos = [0,0];
    grid_size = [window.innerWidth, window.innerHeight];
}
